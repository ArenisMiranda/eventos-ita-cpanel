...
require '/home4/conveni2/public_html/eventos/views/libs/libreria/PHPmailer/src/PHPMailer.php';
require '/home4/conveni2/public_html/eventos/views/libs/libreria/PHPmailer/src/SMTP.php';
require '/home4/conveni2/public_html/eventos/views/libs/libreria/PHPmailer/src/Exception.php';
            ...
            if (
                ...
                $claveCurso = $_POST["idCurso"];
                                ...
                                Te informamos que tu registro fue un ÉXITO, corrobora la información que proporcionaste: <br>
                                    ...
                                    Correo: '.$correo.'<br>
                                DESCARGA E IMPRIME TU PASE DE REGISTRO DEL EVENTO/CONFERENCIA QUE TE REGISTRASTE en la siguiente liga --> <a href="http://mx64.prueba.site/~conveni2/eventos/views/components/cursos/registropdf/confirmacion.php?folio='.$claveCurso.'&persona='.$identificacion.'" target="_blank">PASE DE REGISTRO</a>, DEBERÁS PRESENTARLO, DE LO CONTRARIO NO PODRÁS ACCESAR AL EVENTO.';
