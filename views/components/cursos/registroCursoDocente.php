...
$respuesta = ControlladorCursos::ctrAltaCursosPersonasDocente();
switch ($respuesta) {
                            ...
                            <div class="content" style="font-size: 14px;">
                                ...
                                <?php else : ?>
                                    ...
                                    <div class="col text-center mt-2">
                                        <a class="btn-a" data-bs-toggle="modal" data-bs-target="#exampleModal1" data-bs-whatever="<?php echo $value['nombre_curso'] . "/" .  $value['clave'] ?>">SI QUIERO REGISTRARME</a>
                                    </div>
                ...
                <div class="container-fluid px-5 py-5">
                    <form class="row g-3" action="" method="POST">
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control" id="inputNombre" placeholder="Ej. Arenis Miranda" name="nombreCompletoDocente" required>
                        </div>
                        <div class="col-12">
                        ...
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-success" name="registrarseACursoDocente">Registrarse</button>
